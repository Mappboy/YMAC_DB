...
urlpatterns = [
    ...
    url(r'^workbenches/region_distance/$', views.RegionDistanceView.as_view(), name='regiondist'),
    url(r'^spatial_request/$', views.SpatialRequestView.as_view(), name='spatial_request'),
